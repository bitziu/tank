...
public class Main {
    public static int [] heroessHealth={250,250,250,400};
    public static int bossHealth = 700;
    public static int bossAttack = 50;
    public static int []heroesAttack = {20,20,20,10};
    public static String bossDefenceType = "";
    public static String[] heroesAttackType = {"Physical","Magical","Kinetic","Tank"};
    //public static int Tank =20;
    ...
    public static void bossHit() {
        for (int i = 0; i < heroessHealth.length; i++) {
            ...
            if (heroessHealth[3] > 0) {
                Random r = new Random();
                int randomNumber = r.nextInt(3) + 2;
                heroessHealth[3] = heroessHealth[3] - ((bossAttack * randomNumber));
                heroessHealth[i] = heroessHealth[i] - (bossAttack/2);
    ...
    public static void printStatistics(int round){
        ...
        System.out.println("Tank" + heroessHealth [3]);
